...
public class UsuarioServiceImpl implements UsuarioService {
	...
	public UsuarioDTO update(Long id, UsuarioDTO usuarioDto) {
		...
		if (usuarioDto.getEsJefe() != null) {
			usuarioToUpdate.setEsJefe(usuarioDto.getEsJefe());
		}
		if (usuarioDto.getBorrado() != null) {
			usuarioToUpdate.setBorrado(usuarioDto.getBorrado());
		}
	...
	public UsuarioDTO borrado(Long id) {
		Usuario usuarioToUpdate = usuarioRepository.findById(id).get();
		usuarioToUpdate.setBorrado(!usuarioToUpdate.getBorrado());
		return convertirToDto(usuarioRepository.save(usuarioToUpdate));
	}

	@Override
	public UsuarioDTO jefe(Long id) {
		Usuario usuarioToUpdate = usuarioRepository.findById(id).get();
		usuarioToUpdate.setEsJefe(!usuarioToUpdate.getEsJefe());
		return convertirToDto(usuarioRepository.save(usuarioToUpdate));
	}
